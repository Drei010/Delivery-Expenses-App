...
<html>
  ...
  <input   class="btn btn-outline-success " type="submit" value="Today's Expenses">
    ...
    <h2 class="display-3">Record Your </h2>
    <h2 class="display-3">Delivery</h2>
    <h2 class="display-3">Expenses</h2>
    </div>
     ...
     <div class="col-sm text-start">
         ...
         <form action="AppController" method="get">
<input name="instruction" type="hidden" value="3"/>
 <h4><label for="item">Item</label></h4>
<input class="form-control input-lg" name="item" id="item" type="text" required/> 
  <h4><label for="description">Item Description</label></h4>
 <input class="form-control input-lg" name="description" id="description" type="text" required/>
 <h4><label for="source">Delivery Source</label></h4>
 <input class="form-control input-lg"  name="source" id="source" type="text" required/> 
 <h4><label for="price">Price</label></h4>
<input class="form-control input-lg" name="price" id="price" type="number" step="0.01" required/>
<input name="selectDate" id="selectDate" type="hidden"/>
<input name="idNumber" id="idNumber" type="hidden"/>
 <br> <input class="btn btn-outline-secondary btn-lg" type="submit">
       ...
       <div class="col-sm">
        <div class="container  rounded " name="instructions" >
            <br>
      <h2>Instructions</h2>
       <p class="justify-content-start"> Change the values in the text box.</p>
       <br>
       </div>
    </div>
...
document.getElementById("selectDate").value = params.get('selectDate'); 
