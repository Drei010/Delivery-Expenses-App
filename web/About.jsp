  ...
  <input   class="btn btn-outline-success " type="submit" value="Today's Expenses">
         ...
         <div class="container float-left align-items-center">
             ...
             <div class="row"><br><br><br></div>
               ...
               <img class="w-100" src="CSS/ImagesFolder/logoOfficial.png" alt="APP Logo" draggable="false"   />
          </div>  
                    
    <div class="col-sm text-start " name="title">
    <h2 class="display-2">Delivery</h2>
    <h2 class="display-2">Expenses</h2>
    <h2 class="display-2">Records</h2>
    </div>
    ...
    <div class="col-sm">
        <div class="container rounded" name="instructions">
            <br>
      <h2>About</h2>
       <p class="justify-content-start"> Due to the pandemic people have resorted to 
           ordering their needs online. The Delivery Expenses Records App is designed to help users
       keep track of their delivery expenses.</p>
       <br>
       </div>
    </div>
