<%-- 
    ...
    Author     :Andrei Kyle A. Hidalgo 2CSB
--%>
...
<html>
  ...
  <input   class="btn btn-outline-success " type="submit" value="Today's Expenses">
    ...
    <h2 class="display-3">Expenses</h2>
       ...
       <form action="AppController" method="get">
  <input class="form-control input-lg" type="date"  name="selectDate">
  <input type="hidden" name="instruction" value="1">
  <br>
  ...
  <input class="btn btn-outline-secondary btn-lg" type="submit">
    ...
    <div class="col-sm">
        <div class="container  rounded " name="instructions" >
            <br>
      <h2>Instructions</h2>
       <p class="justify-content-start"> Select a Date to view the records of the deliveries that were received on that day. 
           Select March 2 2022 for example</p>
       <br>
       </div>
    </div>
